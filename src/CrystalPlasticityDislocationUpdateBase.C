...
InputParameters
CrystalPlasticityDislocationUpdateBase::validParams()
{
...
CrystalPlasticityDislocationUpdateBase::CrystalPlasticityDislocationUpdateBase(
...
void
CrystalPlasticityDislocationUpdateBase::getSlipSystems()
{
...
void
CrystalPlasticityDislocationUpdateBase::transformHexagonalMillerBravaisSlipSystems(
...
void
CrystalPlasticityDislocationUpdateBase::sortCrossSlipFamilies()
{
...
unsigned int
CrystalPlasticityDislocationUpdateBase::identifyCrossSlipFamily(const unsigned int index)
{
  for (unsigned int i = 0; i < _number_cross_slip_directions; ++i)
    for (unsigned int j = 0; j < _number_cross_slip_planes; ++j)
...
void
CrystalPlasticityDislocationUpdateBase::calculateFlowDirection(const RankTwoTensor & crysrot)
{
...
void
CrystalPlasticityDislocationUpdateBase::calculateSchmidTensor(
...
void
CrystalPlasticityDislocationUpdateBase::calculateShearStress(
...
void
CrystalPlasticityDislocationUpdateBase::calculateTotalPlasticDeformationGradientDerivative(
...
void
CrystalPlasticityDislocationUpdateBase::setQp(const unsigned int & qp)
{
  _qp = qp;
}

void
CrystalPlasticityDislocationUpdateBase::setSubstepDt(const Real & substep_dt)
{
  _substep_dt = substep_dt;
}

bool
CrystalPlasticityDislocationUpdateBase::isConstitutiveStateVariableConverged(
